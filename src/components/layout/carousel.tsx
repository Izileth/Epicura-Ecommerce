...
export function MinimalistCarousel({ items, autoPlay = true, interval = 5000, className }: CarouselProps) {
    ...
    return (
        ...
        <MotionConfig  transition={{ duration: 0.7, ease: [0.32, 0.72, 0, 1] }}>
            <div className="relative aspect-[16/9] md:h-auto md:aspect-[2/1] overflow-hidden ">
            <AnimatePresence initial={false} custom={direction}>
                ...
                />
                <div className="absolute inset-0 flex flex-col justify-center items-center md:items-start p-6 md:p-20 z-20  text-white">
                    <motion.h2
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.2 }}
                    className="text-2xl md:text-7xl  font-medium mb-2"
                    >
                    {currentItem.title}
                    </motion.h2>
                    <motion.p
                    ...
                    className="text-sm md:text-base text-center md:text-left max-w-md opacity-90"
                    >
            ...
            <div className="mt-4 absolute bottom-0  mb-4 md:mb-16 left-0 right-0 flex justify-center gap-2">
            {items.map((_, i) => (
                <button
                key={i}
        ...
        {/*
            ...
            >
                ...
                <Button asChild className="group inline-flex items-center gap-2 bg-neutral-900 text-white hover:bg-neutral-800">
                <a href="/products">
